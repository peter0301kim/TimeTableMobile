...
namespace TimeTableMobile
{
    class GlobalSettings
    {
        ...
        public string TimeTableApiLogInEndPoint { get; set; }
        public string TimeTableApiSubjectEndPoint { get; set; }
        public GlobalSettings()
        {
            AuthToken = "INSERT AUTHENTICATION TOKEN";

            TimeTableApiBaseUrl = "http://localhost";
            TimeTableApiLogInEndPoint = "/api/v1/login";
            TimeTableApiSubjectEndPoint = "/api/v1/subject";
